...
import com.example.ar1.game.molegame.game_end;
...
public class AlarmGameProcess extends AppCompatActivity {
Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        difficulty = sharedPreferences.getString("selected_stretching_count_" + alarmId, "default");

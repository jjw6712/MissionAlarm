...
public class AlarmMyService extends Service implements SensorEventListener {
    ...
    private Notification createNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "AlarmstepForeground");
        ...
        Intent notificationIntent = new Intent(this, AlarmPedometerActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0,
                notificationIntent,
                PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);

        builder.setContentTitle("만보계 미션 진행중")
                .setContentText("미션 걸음 : "+stepCount)
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_STEP_DETECTOR) {
            // 걸음 수 변경에 대한 기존 로직
            // 측정된 걸음 수 가져오기
            stepCount = (int) event.values[0]- Alarmpedometer.getStepCount(this);

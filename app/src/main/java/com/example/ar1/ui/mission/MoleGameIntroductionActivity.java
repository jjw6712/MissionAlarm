...
import com.example.ar1.game.molegame.game_selection;

public class MoleGameIntroductionActivity extends AppCompatActivity {
    ImageButton btBack;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_molegame_introduction);
        Window window = getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.setStatusBarColor(getResources().getColor(android.R.color.black));
        btBack = findViewById(R.id.btBack);
        VideoView videoView = findViewById(R.id.videoView);
        String videoFileName = "molegame"; // 동영상 파일 이름
...
// 동영상 재생 시작
        ...
        startSquatMissionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 미션 시작 다이얼로그 표시
                Intent intent = new Intent(MoleGameIntroductionActivity.this, game_selection.class);

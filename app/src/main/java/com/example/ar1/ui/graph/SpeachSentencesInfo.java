...
public class SpeachSentencesInfo extends AppCompatActivity {
    ImageButton btBack;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_speachsentences_info); // XML 레이아웃 파일명을 입력하세요.
    ...
    private void openWordListActivity(String timeFrame) {
        Intent intent = new Intent(SpeachSentencesInfo.this, SentencesListActivity.class);

...
public class QuizIntroductionActivity extends AppCompatActivity {
    ImageButton btBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String videoFileName = "quiz"; // 동영상 파일 이름
    ...
    private void showDifficultyDialog() {
        ...
        buttonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(QuizIntroductionActivity.this, Quiz.class);
